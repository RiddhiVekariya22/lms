				...
				>
					...
					<div v-if="questionDetails.data.type == 'Choices'" v-for="index in 4">
						<label
							...
							class="quiz-option flex items-center w-full cursor-pointer"
						>
							<input
...
.quiz-option:hover {
	...
	background: color-mix(in oklab, #ee6708 4%, rgb(var(--surface-white)));
	box-shadow: 0 0 0 3px color-mix(in oklab, #ee6708 6%, transparent);
}

.quiz-option:has(:checked) {
	border-color: #ee6708;
	background: color-mix(in oklab, #ee6708 8%, rgb(var(--surface-white)));
	box-shadow: 0 0 0 3px color-mix(in oklab, #ee6708 10%, transparent);
}
</style>
